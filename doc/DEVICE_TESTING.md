...
All 4 protocols (SCSI, HID, LED, Bulk) are implemented with **2349 automated tests**. Several HID/LED devices have been validated by testers. If you have a device not listed below, please help test.
