...
**Branch:** `main`
**Tests:** 5323 across 89 files in 9 hexagonal directories
...
- **REST API** — 53 endpoints with full CLI parity (`trcc serve`), Pydantic models, uses LCDDevice/LEDDevice from core/
...
| 23 | REST API full CLI parity | Done — 53 endpoints, Pydantic models, uses LCDDevice/LEDDevice |
