...
class BaseThemeBrowser(BasePanel):
    ...
    def _load_filter_assets(self):
        ...
        from .assets import Assets
        normal = Assets.load_pixmap('P_theme_category_select.png', Sizes.FILTER_BTN_W, Sizes.FILTER_BTN_H)
        active = Assets.load_pixmap('P_theme_category_select_0.png', Sizes.FILTER_BTN_W, Sizes.FILTER_BTN_H)
