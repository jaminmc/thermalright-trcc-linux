...
class UCPreview(BasePanel):
    ...
    RESOLUTION_OFFSETS = {
        ...
        (640, 480): (90, 130, 320, 240, 'P预览320X240.png'),
        (480, 640): (130, 90, 240, 320, 'P预览240X320.png'),
        (640, 172): (90, 207, 320, 86, 'P预览320X86.png'),
        (172, 640): (207, 90, 86, 320, 'P预览86X320.png'),
        ...
        (960, 320): (10, 170, 480, 160, 'P预览480X160.png'),
        (320, 960): (170, 10, 160, 480, 'P预览160X480.png'),
        ...
        (1920, 440): (10, 195, 480, 110, 'P预览480X110.png'),
        (440, 1920): (195, 10, 110, 480, 'P预览110X480.png'),
